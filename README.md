<strong>Редактор параметров</strong>
<br>
Есть следующие структуры данных:
* описывающих товар – интерфейс Model;
* набор параметров этого товара. 
...
редактирования, а переданные значения в структуре проставлены в форме редактирования, которые передаются в params: Param[], а так же позволяют получить
